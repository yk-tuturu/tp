...
public class CommandTestUtil {
    ...
    public static final String PHONE_DESC_AMY = " " + PREFIX_PARENTPHONE + VALID_PHONE_AMY;
    public static final String PHONE_DESC_BOB = " " + PREFIX_PARENTPHONE + VALID_PHONE_BOB;
    public static final String EMAIL_DESC_AMY = " " + PREFIX_PARENTEMAIL + VALID_EMAIL_AMY;
    public static final String EMAIL_DESC_BOB = " " + PREFIX_PARENTEMAIL + VALID_EMAIL_BOB;
